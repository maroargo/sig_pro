            ...
            <tbody className="text-gray-700">
              {filteredData.length > 0 ? (
                filteredData.map((user) => (
                  ...
                  >
                    <td className="px-4 py-2"><b>{user.name}</b> <br /> {user.email} <br /> {user.phone}</td>                                                            
                    <td className="px-4 py-2">{user.subgerencia?.gerencia?.siglas} - {user.subgerencia?.gerencia?.nombre} 
                      <br /> {user.subgerencia?.siglas} - {user.subgerencia?.nombre}</td>
